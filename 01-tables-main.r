...
ggsave("Figures/dropacountry.png",gg_comb,width=6.5,height=4.5,dpi="retina",device="png")

ggsave("Figures/dropacountry.eps",gg_comb,width=6.5,height=4.5,dpi="retina",device="eps")
...
ggsave("Figures/dropayear.png",gg_comb,width=6.5,height=4.5,dpi="retina",device="png")

ggsave("Figures/dropayear.eps",gg_comb,width=6.5,height=4.5,dpi="retina",device="eps")
...
impact3 <- function(x){
  x[,`:=`(shock=sd(rain)),by=.(xy)]
  r1 <- feols(incidents~area:seas + area:seas:irri+(area:seas + area:seas:irri):rain+rain_t | xy+country^year+yearmo, data=x,vcov=~xy)
  r2 <- feols(incidents~area:seas + area:seas:irri+(area:seas + area:seas:irri):I(rain-shock)+rain_t | xy+country^year+yearmo, data=x,vcov=~xy)
  r3 <- feols(incidents~area:seas + area:seas:I(1-irri)+(area:seas + area:seas:I(1-irri)):rain+rain_t | xy+country^year+yearmo, data=x,vcov=~xy)
  r4 <- feols(incidents~area:seas + area:seas:I(1-irri)+(area:seas + area:seas:I(1-irri)):I(rain-shock)+rain_t | xy+country^year+yearmo, data=x,vcov=~xy)
...
## effect
coef0_fe <- feols(incidents~area:seas+area:seas:irri+(area:seas+area:seas:irri):rain+rain_t | xy+country^year+yearmo, datasub_dt,vcov=~xy)
...
## effect
coef1_fe <- feols(incidents~area:seas+area:seas:irri+(area:seas+area:seas:irri):rain+rain_t | xy+country^year+yearmo, datasub_dt[event=="battles"],vcov=~xy)
coef2_fe <- feols(incidents~area:seas+area:seas:irri+(area:seas+area:seas:irri):rain+rain_t | xy+country^year+yearmo, datasub_dt[event=="violence"],vcov=~xy)
coef3_fe <- feols(incidents~area:seas+area:seas:irri+(area:seas+area:seas:irri):rain+rain_t | xy+country^year+yearmo, datasub_dt[event=="riots" ],vcov=~xy)
coef4_fe <- feols(incidents~area:seas+area:seas:irri+(area:seas+area:seas:irri):rain+rain_t | xy+country^year+yearmo, datasub_dt[event=="protests"],vcov=~xy)
