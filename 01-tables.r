...
datasub_dt[,`:=`(area=area_spam,seas=ifelse(rice_m==1 | rice_s==1 | rice_e==1,1,0))]
...
## combined effect ----
datasub_dt <- datacomb_dt
datasub_dt[,`:=`(area=area_spam,seas=ifelse(rice_m==1 | rice_s==1 | rice_e==1,1,0))]#harvest_season
