...
ggsave("Figures/results_main_incidence.png",gg_main,width=6.5,height=4.0,dpi="retina")
...
ggsave("Figures/results_rain_incidence.png",gg_rain,width=6.5,height=4.0,dpi="retina")
...
ggsave("Figures/results_irri_incidence.png",gg_irri,width=6.5,height=4.0,dpi="retina")
...
ggsave("Figures/results_conflict_incidence.png",gg_rain,width=6.5,height=4.0,dpi="retina")
