...
# It amplifies violence and (maybe) reduces protests
...
.pull-right[
![Conflict and Cropland](Figures/area_conflict.png)
]
...
![Omit a Country](Figures/dropacountry.png)
...
![Omit a Year](Figures/dropayear.png)
...
![Conflict over time without Myanmar](Figures/ts_conflict_myanmar.png)
...
# When we omit Myanmar 2021-2022 data...

.pull-left[

Violence increases (but nothing else changes)

]

.pull-right[

![Main Results without Myanmar](Figures/results_main_myanmar.png)
...
# When we use incidence as the outcome variable...

.pull-left[

Battles and Violence increase (protests and riots don't change)

]

.pull-right[

![Main Results with Incidence](Figures/results_main_incidence.png)
...
# The specification chart (incidents, full sample)

.left-half[

The effect on violence robust across specifications.

The effect on protests not significant in most instances (even with full sample)

]

.right-half[

![Main Results with Incidence](Figures/spec.png)
...
Although, some of this may be offset by *resentment*, i.e., when people feel being worse off only because others are doing well.
]
...
# The cropland size aplifies the effects 

.pull-right[
![Dose](Figures/dose.png)
]
...
.pull-right[
![Rain](Figures/results_rain_myanmar.png)
]
...
.pull-right[
![Irrigation](Figures/results_irri_myanmar.png)
]
